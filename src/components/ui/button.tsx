  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        emergency: "bg-emergency text-emergency-foreground hover:bg-emergency-hover shadow-emergency emergency-pulse font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft",
        module: "bg-gradient-primary text-primary-foreground hover:shadow-card hover:scale-105 transition-all duration-300",
        drill: "bg-gradient-accent text-accent-foreground hover:shadow-card hover:scale-105 transition-all duration-300",
      },
      size: {
        ...
        icon: "h-10 w-10",
        emergency: "h-16 w-16 rounded-full text-xl font-bold",
      },
    },
    defaultVariants: {
      variant: "default",
